window.onload = init();
function init() {
    canvas = document.getElementById('bubblebackground');
    parent = document.getElementById('bubblebackgroundparent');
    ...
    mouse = { x: 0, y: 0 };
    colors = ['rgba(166, 38, 33,0.8)', 'rgba(45, 69, 166,0.8)', 'rgb(133, 133, 133,0.8)'];
